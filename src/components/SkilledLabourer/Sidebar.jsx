...
import { FiHome, FiUser, FiSearch, FiPackage, FiSettings, FiInfo, FiHeadphones, FiLogOut, FiChevronLeft } from 'react-icons/fi';
  ...
  return (
    <div className="sb-sidebar">
      ...
      <div className="sb-sidebar-footer">
        <div className="sb-sidebar-user"><div className="sb-sidebar-avatar">{currentUser?.name?.[0]?.toUpperCase() || 'S'}</div><div className="sb-sidebar-user-info"><span className="sb-sidebar-user-name">{currentUser?.name?.split(' ')[0] || 'Skilled'}</span><span className="sb-sidebar-user-role">Skilled Labourer</span></div></div>
