  ...
  return (
    <div className="sb-sidebar">
      ...
      <div className="sb-sidebar-footer">
        <div className="sb-sidebar-user"><div className="sb-sidebar-avatar">{currentUser?.name?.[0]?.toUpperCase() || 'C'}</div><div className="sb-sidebar-user-info"><span className="sb-sidebar-user-name">{currentUser?.name?.split(' ')[0] || 'Contractor'}</span><span className="sb-sidebar-user-role">Contractor</span></div></div>
